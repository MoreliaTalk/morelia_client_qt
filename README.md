...
После чего у нас будет создано новое виртуальное окружение. Теперь пора установить библиотеки. Для установки нужных для запуска клиента библиотек, а также библитек, нужных только при разработке, вводим в консоли следущую команду:

```cmd
pipenv install --dev --ignore-pipfile
```

Если вам нужны только библиотеки для запуска клиента, то вводим в консоли следущую команду:
