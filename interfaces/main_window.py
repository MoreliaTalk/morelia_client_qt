...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.chatVerticalLayout = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents)
        self.chatVerticalLayout.setObjectName("chatVerticalLayout")
        self.ContactsContent = QtWidgets.QVBoxLayout()
        self.ContactsContent.setObjectName("ContactsContent")
        self.chatVerticalLayout.addLayout(self.ContactsContent)
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.chatVerticalLayout.addItem(spacerItem)
        ...
        self.MessageAreaContentLayout.addItem(spacerItem1, 0, 0, 1, 2)
